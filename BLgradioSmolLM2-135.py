...
import tiktoken
import datetime
#https://huggingface.co/bartowski/SmolLM2-135M-Instruct-GGUF/tree/main

client = OpenAI(base_url="http://localhost:8080/v1", api_key="not-needed")
STOPS = ['<|im_end|>'] #'<|end_of_text|>' for granite
MODELNAME = 'SmolLM2-135M-Instruct-GGUF'  #SmolLM2-135M-Instruct-f16.gguf
...
writehistory(LOGFILENAME,f'Advanced AI ChatBot Interface - Running *{MODELNAME}* with llamaCPP-server\n{datetime.datetime.now()}\n---\n\n')
